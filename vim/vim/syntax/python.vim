...
if s:Enabled("g:python_highlight_builtin_funcs")
  if s:Python2Syntax()
    ...
    syn keyword pythonMagicMethod __unicode__ __div__ __coerce__ __cmp__
    syn keyword pythonMagicMethod __nonzero__
  else
  ...
  syn keyword pythonMagicMethod __abs__ __add__ __and__ __call__ __ceil__
  syn keyword pythonMagicMethod __complex__ __contains__ __copy__ __deepcopy__
  syn keyword pythonMagicMethod __del__ __delattr__ __delete__ __delitem__
  syn keyword pythonMagicMethod __dir__ __div__ __divmod__ __enter__ __eq__
  syn keyword pythonMagicMethod __exit__ __float__ __floor__ __floordiv__
  syn keyword pythonMagicMethod __format__ __ge__ __get__ __getattr__
  syn keyword pythonMagicMethod __getattribute__ __getinitargs__ __getitem__
  syn keyword pythonMagicMethod __getnewargs__ __getstate__ __gt__ __hash__
  syn keyword pythonMagicMethod __hex__ __iadd__ __iand__ __idiv__ __ifloordiv__
  syn keyword pythonMagicMethod __ilshift__ __imod__ __imul__ __index__ __init__
  syn keyword pythonMagicMethod __instancecheck__ __int__ __invert__ __ior__
  syn keyword pythonMagicMethod __ipow__ __irshift__ __isub__ __iter__
  syn keyword pythonMagicMethod __itruediv__ __ixor__ __le__ __len__ __long__
  syn keyword pythonMagicMethod __lshift__ __lt__ __metaclass__ __missing__
  syn keyword pythonMagicMethod __mod__ __mul__ __ne__ __neg__ __new__ __oct__
  syn keyword pythonMagicMethod __or__ __pos__ __pow__ __radd__ __rand__
  syn keyword pythonMagicMethod __rdiv__ __rdivmod__ __reduce__ __reduce_ex__
  syn keyword pythonMagicMethod __repr__ __reversed__ __rfloordiv__ __rlshift__
  syn keyword pythonMagicMethod __rmod__ __rmul__ __ror__ __round__ __rpow__
  syn keyword pythonMagicMethod __rrshift__ __rshift__ __rsub__ __rtruediv__
  syn keyword pythonMagicMethod __rxor__ __set__ __setattr__ __setitem__
  syn keyword pythonMagicMethod __setstate__ __sizeof__ __str__ __sub__
  syn keyword pythonMagicMethod __subclasscheck__ __truediv__ __trunc__ __xor__
endif
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonMagicMethod      Function
